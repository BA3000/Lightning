...
namespace OpenBLive.Runtime
{
    ...
    public class InteractivePlayHeartBeat : IDisposable
    {
        ...
        public InteractivePlayHeartBeat(string gameId, int time = 200000, CancellationTokenSource cancellation = null)
        {
        ...
        public InteractivePlayHeartBeat(string[] gameIds, int time = 200000, CancellationTokenSource cancellation = null)
        {
            m_GameIds = gameIds;
            m_Time = time;
            m_Cancellation = cancellation ?? new CancellationTokenSource();
